...
def decode_feedback(data: bytes):
    ...
    # --- position: signed int16, map linearly to [-12.5, +12.5] ---
    pos_raw_u16 = (data[1] << 8) | data[2]
    pos_raw_i16 = pos_raw_u16 - 0x10000 if (pos_raw_u16 & 0x8000) else pos_raw_u16
    # שימוש בסקייל חתום (32767 לשמירה על סימטריה לצד החיובי)
    ...
    return drv_id, pos_rad, vel_rad_s, tau_nm, pos_raw_i16, vel_s12, tau_s12
...
def main():
    ...
    # מומלץ: לאפס נקודת אפס לפני ניסויים כדי לקבל pos הגיוני
